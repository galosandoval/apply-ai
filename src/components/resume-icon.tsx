...
const iconPaths = {
  ...
  camera:
    "M3 8h4l2-3h6l2 3h4v11H3V8Zm9 8a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z",
  running: "M13 4a1.5 1.5 0 1 0 0-.01M9 21l3-5-3-3 1-5 3 3 3 1M6 12l2-4",
  cycling:
  ...
  travel: "M2 12h20M12 2a15 15 0 0 1 0 20 15 15 0 0 1 0-20Zm0 0a10 10 0 1 0 0 20 10 10 0 0 0 0-20Z",
  gaming:
    "M7 12h4m-2-2v4m5-1h.01M17 11h.01M6 7h12a4 4 0 0 1 4 4v2a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4v-2a4 4 0 0 1 4-4Z",
  hiking: "M3 20h18M7 20l4-12 3 5h3l3 7M11 5a1.5 1.5 0 1 0 0-.01",
  ...
  garden: "M12 21V10m0 0c0-3 2-5 5-5 0 3-2 5-5 5Zm0 0c0-3-2-5-5-5 0 3 2 5 5 5ZM8 21h8",
  chess: "M9 21h6M9 21l1-5h4l1 5M10 16l-1-4h6l-1 4M12 3a3 3 0 0 1 3 3c0 2-3 3-3 6 0-3-3-4-3-6a3 3 0 0 1 3-3Z",
  volunteer:
  ...
  pet: "M6 11a2 2 0 1 0 0-.01M18 11a2 2 0 1 0 0-.01M9 6a2 2 0 1 0 0-.01M15 6a2 2 0 1 0 0-.01M12 13c-3 0-5 2-5 4a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2c0-2-2-4-5-4Z",
  language: "M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18Zm0 0c3 3 3 15 0 18M3 12h18"
} as const

/** The keys the icon picker offers, and the only ones that draw. */
export const resumeIconNames = Object.keys(iconPaths) as ResumeIconName[]
...
/** Draws one icon, or nothing when the key is not one of the fixed set. */
export function ResumeIcon({ name }: { name: string }) {
  if (!isResumeIconName(name)) return null
